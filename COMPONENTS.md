...
| Header | `@/components/layout/header` | Client | Fixed navigation header; mobile menu drives `isNavOpened` (scroll lock), traps focus, closes on Escape/backdrop/desktop resize |
